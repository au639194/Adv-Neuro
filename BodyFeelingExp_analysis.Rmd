...
#How many participants (take first entry pr participant)
uni <- dataBFE[!duplicated(dataBFE$id),]
uni

#Seems like there are some id's who might be the same person. Eye-balling to identify 
...
lines(x=c(0,cos(pp)),y=c(0,sin(pp)),col='red')
...
plot(x=dataBFE$hour2,y=dataBFE$freshCircFit,type='p',col='red')

ggplot(dataBFE,aes(x=hour2,y=fresh))+geom_smooth()+geom_smooth(aes(x=hour2,y=freshCircFit),col='red')+labs(x='Time of day (hours)', y='Tired/Fresh')
```
...
plot(x=dataBFE$hour2,y=dataBFE$CircFit,type='p',col='red')

plot1 <- ggplot(dataBFE,aes(x=hour2,y=mood))+geom_smooth()+geom_smooth(aes(x=hour2,y=CircFit+mean(mood)),col='red')+labs(x='Time of day (hours), 24h', y='Negative/Positive Mood')
```
...
plot(x=dataBFE$hour2,y=dataBFE$HeartRateCircFit,type='p',col='red')

ggplot(dataBFE,aes(x=hour2,y=HeartRate))+geom_smooth()+geom_smooth(aes(x=hour2,y=HeartRateCircFit),col='red')+labs(x='Time of day (hours)', y='Tired/Fresh')
```
...
plot(x=dataBFE$hour2,y=dataBFE$freshCircFit12,type='p',col='red')

ggplot(dataBFE,aes(x=hour2,y=fresh))+geom_smooth()+geom_smooth(aes(x=hour2,y=freshCircFit12),col='red')+labs(x='Time of day (hours)', y='Tired/Fresh')
```
...
plot(x=dataBFE$hour2,y=dataBFE$CircFit12,type='p',col='red')

plot2 <- ggplot(dataBFE,aes(x=hour2,y=mood))+geom_smooth()+geom_smooth(aes(x=hour2,y=CircFit12),col='red')+labs(x='Time of day (hours), 12h', y='Negative/Positive Mood')
```
...
plot(x=dataBFE$hour2,y=dataBFE$HeartRateCircFit12,type='p',col='red')

ggplot(dataBFE,aes(x=hour2,y=HeartRate))+geom_smooth()+geom_smooth(aes(x=hour2,y=HeartRateCircFit12),col='red')+labs(x='Time of day (hours)', y='Tired/Fresh')
```
...
plot(x=dataBFE$hour2,y=dataBFE$freshCircFitBoth,type='p',col='red')

ggplot(dataBFE,aes(x=hour2,y=fresh))+geom_smooth()+geom_smooth(aes(x=hour2,y=freshCircFitBoth),col='red')+labs(x='Time of day (hours)', y='Tired/Fresh')
```
...
plot(x=dataBFE$hour2,y=dataBFE$CircFitBoth,type='p',col='red')

plot3 <- ggplot(dataBFE,aes(x=hour2,y=mood))+geom_smooth()+geom_smooth(aes(x=hour2,y=CircFitBoth),col='red')+labs(x='Time of day (hours), all variables', y='Negative/Positive Mood')
```
#### HeartRate
```{r}
# Freshness: Simple oscillation model
...
plot(x=dataBFE$hour2,y=dataBFE$HeartRateCircFitBoth,type='p',col='red')

ggplot(dataBFE,aes(x=hour2,y=HeartRate))+geom_smooth()+geom_smooth(aes(x=hour2,y=HeartRateCircFitBoth),col='red')+labs(x='Time of day (hours)', y='HeartRate')
```
